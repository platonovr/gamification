 ...
 */
@Component
public class Badge10TaskEndChecker extends AbstractBadgeChecker {
    @Override
    public boolean isBadgeApplicable(Account account) {
        ...
        return tasksByUser.size() >= 10;
    }

    @Override
    public Badge getBadge() {
        try {
            return simpleDao.findById(Badge.class, BadgeConstants.BADGE_10_TASK_END);
        } catch (Exception e) {
            return null;
        }
    }
